...
waterdiepte = 0.3                                                                                   # m, s.e.
werphoogte = 5.0                                                                                      # hoogte vanaf de grond vanwaar de basketbol wordt gegooid
dt = 0.001                                                                                          # s, s.e.
...
while (hoogte > 0):
    ...
    if (hoogte < waterdiepte):
        ...
        luchtweerstand = 0.5 * frontaalOpp * weerstandscoëfficient * dichtheidLucht * snelheid**2
